...
namespace Vertechcon.DynamicLibraries.Utilities
{
    public class LockedResource<TResource>
    {
        ...
        public void Set(TResource value)
        {
            lock(_lockObject)
            {
                _value = value;
        ...
        public void WithResource(Action<TResource> action)
        {
            lock(_lockObject)
            {
                action(_value);
        ...
        public TResult WithResource<TResult>(Func<TResource, TResult> action)
        {
            lock(_lockObject)
            {
